...
public static class OptionSaver
{
    ...
    private static readonly FileInfo OptionSaverFileInfo = new($"{SaveDataDirectoryInfo.FullName}/Options_TOHTmv{Version}.json");
    ...
    public static void Initialize()
    {
        ...
        FileInfo oldinfo = new($"{SaveDataDirectoryInfo.FullName}/Options_TOHTm.json");
        if (oldinfo.Exists)
        {
            oldinfo.Delete();
        }*/
