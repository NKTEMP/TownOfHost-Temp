...
public static class OptionSaver
{
    ...
    private static readonly FileInfo OptionSaverFileInfo = new($"{SaveDataDirectoryInfo.FullName}/Options_TOHSv{Version}.json");
    ...
    public static void Initialize()
    {
        ...
        FileInfo oldinfo = new($"{SaveDataDirectoryInfo.FullName}/Options_TOHS.json");
        if (oldinfo.Exists)
        {
            oldinfo.Delete();
        }*/
