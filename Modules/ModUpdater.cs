...
namespace TownOfHost
{
    ...
    {
        private static readonly string URL = "https://api.github.com/repos/KYMario/TownOfHost-Temp";
            ...
            try
            {
                ...
                else if (all)
                {
                    ...
                    foreach (var release in releases)
                    {
                        ...
                        release.OpenURL = $"https://github.com/KYMario/TownOfHost-Temp/releases/tag/{tag}";
        ...
        private static void ShowPopup(string message, bool showButton = false, string OpenURL = "")
        {
            if (InfoPopup != null)
            {
                ...
                if (button != null)
                {
                    ...
                    {
                        Application.OpenURL(OpenURL == "" ? "https://github.com/KYMario/TownOfHost-Temp/releases/latest" : OpenURL);
                        Application.Quit();
                    }));
                }
            }
