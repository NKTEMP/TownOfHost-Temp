        ...
        {
            {
                ...
                {
                    Number = 100002,
                    Title = "ハッピーハロウィンついにTOH-Sリリース！",
                    SubTitle = "やっとリリースしたよ！",
                    ShortTitle = "◆TOH-S v5.1.14",
                    Text = "ハロウィンにリリースしたのだぁー\n\rってことで(?)TOH-Sを使ってくれてありがとおおお!\n\r\n\rあ、詳しくは<nobr><link=\"https://github.com/KYMario/TownOfHost-S\">README</nobr></link> 見てね～\n\r\n\rマジでここなに書いたらいいんやろな なにも思いつかないぜ(これただ独り言めっちゃ書いてるやばいやつだ)\n\rまぁTOH-Sのこと話します 初リリースってことで元々24役職(ﾈﾀ役職含め)あったのを12役職まで減らしたんだぜ！ 多分いつかアプデで一部は追加すると思う\n\rそ～し～て～実は隠し要素あります！ 1つはコマンド、もう一つは隠しコマンド(key)で使えるようになるよ！<size=40%>\nやぁ。Yだ。1周年記念でニュースを閉じた画面で特定のキーを押す隠しコマンドを追加してみたのさ。\n探してみてネ。ハハハ</size>\n探してみてね\n\rあとYouTubeとかTwitter(X)でTOHSの動画とかじゃんじゃん投稿しちゃって！"
                    + " あ、でもちゃんとMODで本家じゃなくてTOHSってことわかるようにしてね それだけ守ってくれれば.. 配信とか動画で使ってくれるとめちゃ喜びます！\n\rそれじゃあこのぐらいでいいかな、じゃあkを楽しんできてね～\n\r\n\rTOH-S開発者: けーわい,タイガー,夜藍/中の人,ねむa,はろん\nサポーター:りぃりぃ",
...

            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.61.1</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.61.2</color>",
                    Text =
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.61.3</color>",
                    Text =
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.5.1.7.12</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.7.13</color>",
                    ...
                    + "普通、ロビーでは勿論参加者視点チャットやホストの名前の下にTOH-S表示があったりなかったりするくらいでどこに迷い込んでしまったのか分からなかったりすることがたまにあります。\n(まぁKは他Modと結構区別化してますけど!!!(((((()\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.7.14</color>",
                    Text = "とりあえずバグ修正...\n"
                    + "<size=80%>\n\n<size=125%>【追加設定】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.7.15</color>",
                    Text = "<size=80%>"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.8.16</color>",
                    Text = "<size=80%>"
                    + "よ～ら～ん～の～ぽんこつ～！m(__)m\n"
                    + "見直しって必要だね。\n"
                    + "\n<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.8.17</color>",
                    Text = "<size=80%>"
                    + "月が綺麗ですね。"
                    + "\n<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.8.18</color>",
                    Text = "<size=80%>"
                    + "<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.9.18</color>",
                    Text = "<size=80%>"
                    + "<size=125%>【バグ修正】</size>\n"
            ...
            }*/
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v5.1.9.21</color>",
            ...
            }/*
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v519.22</color>",
                    Text = "<size=80%>"
                    + "バージョン表記がちょっと変わりました。\nいい感じに切り替えれる奴の実装で...\n"
                    + "<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v519.22.11</color>",
                    Text = "<size=80%>"
                    + "<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v519.22.12</color>",
                    Text = "<size=80%>"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v519.22.13</color>",
                    Text = "<size=80%>"
                    + "<size=125%>【バグ修正/仕様変更】</size>\n"
                    + "・秘匿チャットが透け透けな問題の修正\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v519.22.14</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v519.23</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v519.23.11</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v519.23.12</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v519.24</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.24.11</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.24.12</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.24.13</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    SubTitle = "<color=#ffcc00>ケーキ屋の再登場だョ!!</color>",
                    ShortTitle = "<color=#ffcc00>ケーキ屋復刻！ ~ 1/8</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.24.14</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.24.15</color>",
                    Text = "<size=80%>\n期間限定役職のバグやから速く直さないと！\n"
                    + "<size=125%>【バグ修正】</size>\n"
                    + "・アウトロ表示がたまに見切れる問題の対応\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.24.16</color>",
                    Text = "<size=80%>\nけーわいさんログまだっすか...\n"
                    + "<size=125%>【バグ修正等】</size>\n"
                    + "・アウトロのテキスト処理を少し変更\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>TOH-Sからの御挨拶</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.519.25</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.25.11</color>",
                    Text = "<size=80%>\n遊べないレベルのバグだから..."
                    + "\n<size=125%>【バグ修正】</size>\n"
                    + "・プロボーラーのキルが亜空間迄飛ぶ問題\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.519.26</color>",
                    Text = "<size=80%>\n遊べないレベルのバグだから..."
                    + "\n<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.26.11</color>",
                    Text = "<size=80%>\nなんか前のニュースコピペされてね!?"
                    + "\n<size=125%>【バグ修正】</size>\n"
                    + "・/hrが全員に表示される問題の修正\n"
            ...
            //100045
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.26.21</color>",
            ...
            //100047
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.26.23(&22)</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.519.26.24</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.519.27</color>",
                    Text = "<size=80%>やぁ！3月だ！\n"
                    + "\n<size=125%>【バグ修正】</size>\n"
                    + "・投票が正常に終了しない問題の対応\n"
            ...
            //100052            
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.11.28.21</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.11.28.23</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.11.28.24</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.11.28.25</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.12.28.31</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.12.28.32</color>",
                    Text = "<size=80%>バグ修正だぜ！\n"
                    + "\n<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.12.29.1x</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.12.29.19</color>",
                    Text = "<size=80%>山やんけ！\n"
                    + "\n<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.12.29.22</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.13.29.23</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.13.29.29</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.13.30</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.13.30.1x</color>",
                    Text = "<size=80%>\n2周年に向けて準備を...(2周年何しよう...)"
                    + "\n<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                ...
                {
                    Number = 100067,
                    Title = "㊗ TOH-S Discord鯖1000人突破！",
                    SubTitle = "<color=#ffcc00>Town Of Host-S v.51.13.30.17</color>",
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.13.30.17</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.13.30.19</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.13.30.27</color>",
                    Text = "<size=80%>少し涼しいね。\n"
                    + "\n<size=125%>【バグ修正】</size>\n"
            ...
            }//100069
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.14.31</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.14.31.14</color>",
                    Text = "<size=80%>"
                    + "<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.14.31.15</color>",
                    Text = "<size=80%>さﾑイ!"
                    + "<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.14.31.21</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.14.31.28</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.14.31.29</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>●TOH-S v.51.14.31.31</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.14.32</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.14.32.31</color>",
                    Text = "<size=80%>"
                    + "<size=125%>【バグ修正】</size>\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.14.32.41</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.14.32.44</color>",
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.14.32.51</color>",
                    Text = "<size=80%>くそあつい。\n"
            ...
            }
            {
                var news = new ModNews
                {
                    ...
                    ShortTitle = "<color=#ffcc00>◆TOH-S v.51.14.32.52</color>",
